...
Usage::
    ...
    [mm] pistol$ git:(master) ✗ rna_pairs_diff.py pistol_dca_all.bp pistol.bp
    # of ec_paris: 31
    # of ssbps   : 18
    dalta#       : 13
    [[4, 32], [6, 9], [6, 36], [6, 39], [9, 39], [13, 32], [16, 17], [17, 18], [22, 49], [23, 25], [24, 25], [24, 62], [29, 58]]
...
def get_parser():
    ...
    parser.add_argument('pairs2', help="a list of pairs to subtract, A-B, results in C (all pairs that are in A and are not in B")
