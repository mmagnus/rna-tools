...
project = u'rna-pdb-tools'
copyright = u'2016, Marcin Magnus et al.'
author = u'Marcin Magnus et al.'
...
htmlhelp_basename = 'rna-pdb-toolsdoc'
...
man_pages = [
    (master_doc, 'rna-pdb-tools', u'rna-pdb-tools Documentation',
     [author], 1)
]
