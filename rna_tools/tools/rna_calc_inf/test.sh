...
rna_calc_inf.py -o test_data/pistol_inf.csv -t ../rna_calc_rmsd/test_data/pistol/5k7c_clean_onechain_renumber_as_puzzle_srr.pdb ../rna_calc_rmsd/test_data/pistol/clusters/*.pdb -m 0

rna_calc_inf.py -t ../rna_calc_rmsd/test_data/pistol/clusters/5k7c_clean_onechain_renumber_as_puzzle_srr.pdb ../rna_calc_rmsd/test_data/pistol/clusters/*.pdb --no-stacking -pr -o test_data/pistol_inf_nostacking.csv > test_data/pistol_inf_nostacking.log
