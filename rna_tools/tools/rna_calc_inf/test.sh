...
# live stacking on!
##rna_calc_inf.py -t ../rna_calc_rmsd/test_data/pistol/clusters/5k7c_clean_onechain_renumber_as_puzzle_srr.pdb ../rna_calc_rmsd/test_data/pistol/clusters/*.pdb --no-stacking -pr -o test_data/pistol_inf_nostacking.csv -f | tee test_data/pistol_inf_with_nostacking.log

rna_calc_inf.py -t ../rna_calc_rmsd/test_data/pistol/clusters/5k7c_clean_onechain_renumber_as_puzzle_srr.pdb ../rna_calc_rmsd/test_data/pistol/clusters/*.pdb -pr -o test_data/pistol_inf_stacking.csv -f #| tee test_data/pistol_inf_with_stacking.log
