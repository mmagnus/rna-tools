...
./triplexibility.py --triple-mode -t data/t1-1-Triple_cWW_cHS_GCU_exemplar_rpr_fx.pdb db/triples-all-v2-rpr/* --result data/t1-1-Triple_cWW_cHS_GCU_exemplar_rpr_fx.csv --sort #--save #--debug

./triplexibility.py --triple-mode -t data/t1-1-Triple_cWW_cHS_GCU_exemplar_rpr_fx.pdb \
