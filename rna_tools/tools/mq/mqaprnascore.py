...
def single_run(filename):
    ...
    for m in methods:
            ...
            if m == 'FARNA':
                mfull = m
                arguments = [filename] + ['False']  # must be True

            if m == 'FARNA_hires':
                m = 'FARNA'
                mfull = 'FARNA_hires'
                arguments = [filename] + ['True']  # must be True
