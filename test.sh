...
./yapdb_parser.py --nohr --get_rnapuzzle input/1xjr_onlyGTP.pdb

./yapdb_parser.py --nohr --get_rnapuzzle input/1xjr_onlyGTP.pdb > output/1xjr_onlyGTP_rnapuzzle_ready.pdb

./yapdb_parser.py --nohr --clean input/1osw.pdb > output/1osw_NMR_1.pdb

./yapdb_parser.py --nohr --get_rnapuzzle input/4GXY_3firstNt.pdb

./yapdb_parser.py --nohr --get_rnapuzzle input/gtp.pdb  > output/gtp.pdb
